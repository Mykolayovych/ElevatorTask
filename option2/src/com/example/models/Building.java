...
public class Building {
    ...
    private int removePassengersFromElevator(){
    ...
    private boolean getDirectionMajorityPeople(){
    ...
    private void showInformationElevator(int step, int removedPassengers, int addedPassengers){
